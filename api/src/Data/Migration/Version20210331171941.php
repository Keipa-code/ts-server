 ...
 */
final class Version20210331171941 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE phone_dircetory (id UUID NOT NULL, private_subscriber_id UUID DEFAULT NULL, juridical_subscriber_id UUID DEFAULT NULL, phonenumber_number VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE subscriber_juridical (id UUID NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, subscriber_type VARCHAR(255) NOT NULL, organization_name VARCHAR(255) NOT NULL, department_name VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, house_number VARCHAR(255) NOT NULL, float_number VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE subscriber_private (id UUID NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, subscriber_type VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, patronymic VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
